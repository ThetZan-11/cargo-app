...
<html>
    ...
    <head>
        ...
        <link rel="apple-touch-icon" href="{{ asset('assets/img/juu.png') }}">
        <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('assets/img/juu.png') }}">
    ...
    <body>
        <div id="loader">
            <dotlottie-player src="https://lottie.host/29ac9208-3f1a-4af8-9281-120c32b5186a/HPbycYNzpQ.lottie"
